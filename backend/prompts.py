"""
LLM prompt definitions for the legal document assistant.

This module centralises all prompt strings and prompt-building logic so that
main.py stays focused on HTTP routing and orchestration.
"""

# Set of document types that are addendums — used by build_chat_prompt to
# inject an extra note reminding users the document must accompany a primary
# agreement.
_ADDENDUM_TYPES = {"AI Addendum", "Mutual NDA Cover Page"}

# ---------------------------------------------------------------------------
# Mutual NDA prompts (used by the hard-coded NDA path in generate_chat_stream)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Generic prompts (used for all non-NDA document types)
# ---------------------------------------------------------------------------
